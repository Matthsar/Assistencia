...
jQuery(document).ready(function($) {
	...
	$("body").on('keydown', function(e) {
        ...
        if(e.keyCode == 39)/* Seta direita */{
            ...
            ultimaSenha2.html(ultimasSenhas.slice(ultimasSenhas.length-2, ultimasSenhas.length-1))
            ultimaSenha3.html(ultimasSenhas.slice(ultimasSenhas.length-3, ultimasSenhas.length-2))
            ultimaSenha4.html(ultimasSenhas.slice(ultimasSenhas.length-4, ultimasSenhas.length-3))
